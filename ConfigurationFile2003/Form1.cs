...
namespace WindowsFormsApplication2003
{
	/// <summary>
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		protected override void OnLoad(EventArgs e) {
			base.OnLoad (e);
			textBoxCLR.Text = Environment.Version.ToString();
		}
		...
		private void InitializeComponent()
		{
			...
			// textBoxCLR
			// 
			this.textBoxCLR.Location = new System.Drawing.Point(104, 8);
			this.textBoxCLR.Name = "textBoxCLR";
			this.textBoxCLR.ReadOnly = true;
			this.textBoxCLR.Size = new System.Drawing.Size(176, 20);
			this.textBoxCLR.TabIndex = 1;
			this.textBoxCLR.Text = "textBox1";
			// 
			// Form1
			// 
